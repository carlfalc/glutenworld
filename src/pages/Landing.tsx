    ...
    <div className="min-h-screen bg-gradient-to-br from-gluten-primary/10 via-gluten-secondary/5 to-background">
      ...
      <header className="container mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {user ? (
            <Button onClick={() => navigate('/dashboard')} className="bg-gluten-primary hover:bg-gluten-primary/90">
              Go to Dashboard
            </Button>
          ) : (
            <>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })} className="text-lg px-8 py-4 border-gluten-primary text-gluten-primary hover:bg-gluten-primary/10">
              Learn More
            </Button>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {keyFeatures.map((feature, index) => (
            <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 hover:scale-105 bg-gradient-to-br from-gluten-primary/5 to-gluten-secondary/5 border-gluten-primary/20 relative">
              <CardHeader className="pb-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  {index === 0 && (
                    <Button onClick={() => setShowFeatureDetails(true)} className="ml-2 bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 flex items-center gap-1" size="sm">
